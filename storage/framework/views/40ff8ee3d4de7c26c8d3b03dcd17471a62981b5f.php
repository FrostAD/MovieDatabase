        ...
        <div class="col mr-2 border px-5 text-center">
            ...
            <div class="row">
                ...
                <div class="col">
                                ...
                                <span><a href="/movie/<?php echo e($exchange->second_movie->id); ?>"><?php echo e($exchange->second_movie->title); ?></a><span><?php echo e($exchange->second_movie->rating); ?>
            ...
            <div class="row justify-content-center">
                <div class="movie-stars" id="form_rating_movie">
                    <form action="/exchange/rate/" method="POST" >
                        ...
                        <?php for($i = 5;$i >= 1;$i--): ?>
                            <?php if($i == $exchange->rating_for_second): ?>
                                <input id="star-<?php echo e($i); ?>-movie" type="radio" name="star"
                                       value="<?php echo e($i); ?>" checked/> <label for="star-<?php echo e($i); ?>-movie"></label>
                            <?php else: ?>
                                <input id="star-<?php echo e($i); ?>-movie" type="radio" name="star"
                                       value="<?php echo e($i); ?>" onchange="this.form.submit()"/> <label for="star-<?php echo e($i); ?>-movie"></label>
                            <?php endif; ?>
                        <?php endfor; ?>
                    </form>
                </div>
...
<?php /**PATH C:\Users\Atanas\Desktop\Project\MovieDatabase\resources\views/view/exchange/auth_first_second_no_ret.blade.php ENDPATH**/ ?>