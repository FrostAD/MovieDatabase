...
use App\Http\Requests\ScreenwritterRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;

/**
 * Class ScreenwritterCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class ScreenwritterCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\Screenwritter::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/screenwritter');
        CRUD::setEntityNameStrings('screenwritter', 'screenwritters');
    }
    ...
    {
        CRUD::setValidation(ScreenwritterRequest::class);
