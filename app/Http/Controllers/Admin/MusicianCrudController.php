...
class MusicianCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\Musician::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/musician');
        CRUD::setEntityNameStrings('musician', 'musicians');
    }
    ...
    {
        CRUD::setValidation(MusicianRequest::class);
